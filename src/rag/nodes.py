...
def route_query(state: GraphState) -> str:
    ...
    Uses Groq Structured Output to guarantee a valid routing decision.
    ...
    system_prompt = SystemMessage(content=(
        "You are an expert intent router for an enterprise RAG system.\n"
        "Your job is to decide the best data source to answer the user's query.\n\n"
        "1. Route to 'vectorstore' for any query seeking specific facts, instructions, lookup data, technical details, codes, names, or domain information.\n"
        "2. Route to 'websearch' ONLY for live real-time internet news, events, or current weather.\n"
        "3. Route to 'general' ONLY for basic conversational greetings (e.g., 'hello', 'hi', 'how are you') or basic arithmetic (e.g., '2+2').\n\n"
        "When in doubt whether information might exist in custom documents, ALWAYS choose 'vectorstore'."
    ))
